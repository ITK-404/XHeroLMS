...
namespace GPUInstancerPro.TerrainModule
{
    ...
    public class GPUITreeManagerEditor : GPUITerrainManagerEditor<GPUITreePrototypeData>
    {
        ...
        protected override void DrawManagerAdvancedSettings()
        {
            ...
            _managerAdvancedSettingsFoldout.Add(DrawSerializedProperty(serializedObject.FindProperty("_isPersistentTreeDataBuffer"), out PropertyField isPersistentTreeDataBufferPF));
            if (Application.isPlaying)
            {
        ...
        {
            GPUITreeManager treeManager = GPUIUtility.FindFirstObjectByType<GPUITreeManager>();
            GameObject go;
            if (treeManager == null)
            {
                go = new GameObject("GPUI Tree Manager");
                treeManager = go.AddComponent<GPUITreeManager>();
                treeManager.AddTerrains(GPUIUtility.FindObjectsByType<GPUITerrain>());
