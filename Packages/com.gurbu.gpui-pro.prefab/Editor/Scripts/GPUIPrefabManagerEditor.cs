...
namespace GPUInstancerPro.PrefabModule
{
    ...
    public class GPUIPrefabManagerEditor : GPUIManagerEditor
    {
        ...
        protected override void BeginDrawPrototypeSettings()
        {
            ...
            if (HasSelectedPrototypesSkinnedMeshRenderers())
            {
#if GPUI_CROWD
                if (OnEnableGPUSkinningModifiedCallback != null)
                {
...
#else
                GPUIEditorUtility.DrawErrorMessage(_prototypeSettingsContentVE, -6100, null, () => Application.OpenURL("https://u3d.as/3yVA"), "Get", GPUIEditorConstants.Colors.green);
#endif
            }
        ...
        {
            GPUIPrefab[] gpuiPrefabs = GPUIUtility.FindObjectsByType<GPUIPrefab>();
