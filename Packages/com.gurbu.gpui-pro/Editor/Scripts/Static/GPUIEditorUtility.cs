...
namespace GPUInstancerPro
{
    public static class GPUIEditorUtility
    {
        ...
        public static void DrawErrorMessage(VisualElement container, int errorCode, UnityEngine.Object targetObject, UnityAction fixAction, string fixButtonText = null, Color? fixButtonColor = null)
        {
            DrawGPUIHelpBox(container, errorCode, targetObject, fixAction, errorCode > 0 ? HelpBoxMessageType.Error : HelpBoxMessageType.Warning, fixButtonText, fixButtonColor);
        }

        public static void DrawGPUIHelpBox(VisualElement container, int errorCode, UnityEngine.Object targetObject, UnityAction fixAction, HelpBoxMessageType messageType, string fixButtonText = null, Color? fixButtonColor = null)
        {
            if (errorCode != 0)
                container.Add(CreateGPUIHelpBox(errorCode, targetObject, fixAction, messageType, fixButtonText, fixButtonColor));
        }

        public static GPUIHelpBox CreateGPUIHelpBox(int errorCode, UnityEngine.Object targetObject, UnityAction fixAction, HelpBoxMessageType messageType, string fixButtonText = null, Color? fixButtonColor = null)
        {
            string textCode = string.Format("Error[{0}]", Mathf.Abs(errorCode));
            return CreateGPUIHelpBox(textCode, targetObject, fixAction, messageType, fixButtonText, fixButtonColor);
        }
        ...
        public static bool IsLoadingAssetPreview(UnityEngine.Object obj)
        {
