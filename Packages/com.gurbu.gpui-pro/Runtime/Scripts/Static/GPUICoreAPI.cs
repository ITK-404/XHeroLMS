...
namespace GPUInstancerPro
{
    public static class GPUICoreAPI
    {
        ...
        /// <summary>
        /// Destroys all materials generated by GPUI and clears their references.
        /// Materials will be regenerated automatically when needed.
        /// </summary>
        public static void ResetMaterials()
        {
            if (!GPUIRenderingSystem.IsActive)
                return;
            GPUIRenderingSystem.Instance.MaterialProvider.Reset();
        }
